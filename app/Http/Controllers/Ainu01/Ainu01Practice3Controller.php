...
class Ainu01Practice3Controller extends Controller
{
    //
    public function index()
    {
        ...
        return view('ainu01/ainu01_practice_3');
    }
    ...
    public function update(Request $request)
    {
        ...
        foreach ($request->input() as $key => $val) {
            ...
            \Auth::user()->ainu01_scores()->where("type", "P3")->latest()->first()->update([$key => $val]);
