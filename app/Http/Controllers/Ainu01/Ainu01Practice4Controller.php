...
class Ainu01Practice4Controller extends Controller
{
    //
    public function index()
    {
        ...
        return view('ainu01/ainu01_practice_4');
    }
    ...
    public function update(Request $request)
    {
        ...
        foreach ($request->input() as $key => $val) {
            ...
            \Auth::user()->ainu01_scores()->where("type", "P4")->latest()->first()->update([$key => $val]);
