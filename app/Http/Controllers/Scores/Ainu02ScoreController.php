...
use App\Models\Ainu02Score;
use Illuminate\Http\Request;
use function Termwind\render;

class Ainu02ScoreController extends Controller
{
    //
    /**
    ...
    {
        //
        $scores = Ainu02Score::all();
        $data = ['scores' => $scores];
        return view('scores.ainu02.index', $data);
    }
     ...
     *
     * @param  \App\Models\Ainu02Score  $score
     * @return \Illuminate\Http\Response
     */
    public function show(int $index)
    {
        ...
        $data = ['score' => $score];
        return view('scores.ainu02.show', $data);
    }

    /**
     * Show the form for editing the specified resource.
     *
     * @param  \App\Models\Ainum02Score  $score
     * @return \Illuminate\Http\Response
     */
    public function edit(int $index)
    {
        ...
        $score = $this->returnScore($index);
        $data = ['score' => $score];
        return view('scores.ainu02.edit', $data);
    }
    ...
    public function update(Request $request, int $index)
    {
        ...
        return redirect(route('ainu02.show', $score->id));
    }
    ...
    public function destroy(int $index)
    {
        ...
        $score = $this->returnScore($index);
        $score->delete();
        return redirect(route('ainu02.index'));
    }
